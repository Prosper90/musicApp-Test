...
export default function Artists(props) {
  ...
  return (
    <div>
        ...
        {/* artists */}
        <div className="nc-PageCollection  " data-nc-id="PageCollection">
  ...
  <div className="container py-16 lg:pb-28 lg:pt-20 space-y-20 lg:space-y-28">
      ...
      <div className="flex lg:space-x-4">
        ...
        <div className="flex overflow-x-auto lg:hidden space-x-4">
          <div className="flex-shrink-0">
            <div className="flex flex-shrink-0 items-center justify-center px-4 py-2 text-sm rounded-full border border-primary-500 bg-primary-50 text-primary-900 focus:outline-none cursor-pointer">
              <span>
          ...
          <div className="flex items-center justify-center px-4 py-2 text-sm rounded-full border focus:outline-none cursor-pointer  border-primary-500 bg-primary-50 text-primary-900">
    ...
    <div className="relative py-20 lg:py-28">
      ...
      />
      <div className="nc-SectionSliderCollections ">
    ...
    >
      <div className="flex-shrink-0 mb-16 lg:mb-0 lg:mr-10 lg:w-2/5">
        ...
        >
          <img
            ...
            src="/ciscryp/static/media/logo.25debea968a8cdc57717f9110ced774d.svg"
            alt="Logo"
          />
          <img
            className="hidden max-h-12 dark:block"
            src="/ciscryp/static/media/logo-light.efd6c8c15ce9ff0f90cc7add4d464ab1.svg"
            alt="Logo-Light"
          />
        </a>
      ...
      <div className="flex-grow">
        ...
        <div className="nc-NcImage hidden dark:block" data-nc-id="NcImage">
          <img
            src="/ciscryp/static/media/rightLargeImgDark.120d1ce1478487c3d02b.png"
            className="object-cover w-full h-full"
            alt="nc-imgs"
          />
        </div>
